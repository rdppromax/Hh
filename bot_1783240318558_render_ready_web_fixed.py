...
# Python 3.14 compatibility: older Pyrogram/PyTgCalls versions expect a
# current asyncio event loop to exist while they are imported.
try:
...
# Render expects a Web Service to listen on the PORT environment variable.
# The Telegram bot itself uses polling, so this tiny stdlib HTTP server runs
# in a daemon thread and only exists to satisfy Render's port check.
class _RenderHealthHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        self.send_response(200)
        self.send_header("Content-Type", "text/plain; charset=utf-8")
        self.end_headers()
        self.wfile.write(b"TOBI bot is running")
...
if __name__ == "__main__":
    _render_server = _start_render_health_server()
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("  ⚡  TOBI V12 ⚡")
